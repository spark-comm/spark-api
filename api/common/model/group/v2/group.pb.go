...
var file_common_model_group_v2_group_proto_goTypes = []any{
...
func file_common_model_group_v2_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_model_group_v2_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_common_model_group_v2_group_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_common_model_group_v2_group_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_common_model_group_v2_group_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_common_model_group_v2_group_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_common_model_group_v2_group_proto_msgTypes[5].Exporter = func(v any, i int) any {
