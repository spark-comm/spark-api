...
func (c *oauth2Client) AccessToken(ctx context.Context, in *AccessTokenRequest, opts ...grpc.CallOption) (*AccessTokenReplay, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AccessTokenReplay)
	err := c.cc.Invoke(ctx, Oauth2_AccessToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type Oauth2Server interface {
	AccessToken(context.Context, *AccessTokenRequest) (*AccessTokenReplay, error)
...
func _Oauth2_AccessToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AccessTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Oauth2Server).AccessToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Oauth2_AccessToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Oauth2Server).AccessToken(ctx, req.(*AccessTokenRequest))
	}
...
var Oauth2_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.user_center.oauth2.v2.Oauth2",
	HandlerType: (*Oauth2Server)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AccessToken",
			Handler:    _Oauth2_AccessToken_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "user_center/oauth2/v2/oauth2.proto",
}
