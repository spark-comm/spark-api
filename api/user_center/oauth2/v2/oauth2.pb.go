...
var file_user_center_oauth2_v2_oauth2_proto_goTypes = []any{
...
func file_user_center_oauth2_v2_oauth2_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_user_center_oauth2_v2_oauth2_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_user_center_oauth2_v2_oauth2_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_user_center_oauth2_v2_oauth2_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_user_center_oauth2_v2_oauth2_proto_msgTypes[3].Exporter = func(v any, i int) any {
