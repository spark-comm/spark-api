...
var file_im_cloud_user_v2_user_proto_goTypes = []any{
...
func file_im_cloud_user_v2_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_im_cloud_user_v2_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_im_cloud_user_v2_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
